...
and release memory transactionally, so data structures built on top of it can
have their allocations committed or rolled back as a unit. See `CLAUDE.md`
for the class/namespace and naming conventions this library follows.
...
- `stm_is_in_transaction` — check whether a transaction is currently active
